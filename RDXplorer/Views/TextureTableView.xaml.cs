...
{
    public partial class TextureTableView : View<TextureTableViewModel, TextureTableViewModelEntry>
    {
        public TextureTableView()
        {
            InitializeComponent();
            LoadModel();
        ...
        private void DataGrid_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            TextureTableViewModelEntry entry = (TextureTableViewModelEntry)grid.SelectedItem;
