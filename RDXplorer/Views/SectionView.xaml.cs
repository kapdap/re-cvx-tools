    ...
    public partial class SectionView : View<SectionViewModel, SectionViewModelEntry>
    {
        ...
        private void DataGrid_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (column == "Value" && entry.Model.IsPointer)
                ...
                Program.Windows.HexEditor.SetPosition(entry.Model.Count.Position, entry.Model.Count.Size);
            else
                Program.Windows.HexEditor.SetPosition(entry.Model.Position, entry.Model.Size);
        }
    }
}